...
class RenewApplicationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var textDate = findViewById<EditText>(R.id.editDate) as EditText
        ...
        buttonNext.setOnClickListener {
            ...
            ApplicationDataTemp.body = "\n\n" + Utils.JSONtoApplication(temp).body
